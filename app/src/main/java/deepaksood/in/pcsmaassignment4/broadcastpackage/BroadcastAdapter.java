 ...
 */
public class BroadcastAdapter extends ArrayAdapter<ChatUserObject> {
    ...
    public BroadcastAdapter(Activity context, int textViewResourceId, List<ChatUserObject> chatUserObjects) {
